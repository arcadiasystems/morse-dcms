...
public fun new_entry(
  ...
  let revision = EntryRevision { blob, content_type, encrypted, access_policy, seal_id, author };
...
public fun append_draft_revision(
  ...
  vector::push_back(
    &mut entry.revisions,
    EntryRevision { blob, content_type, encrypted, access_policy, seal_id, author },
  );
